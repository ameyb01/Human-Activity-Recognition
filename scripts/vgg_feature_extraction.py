...
def extract_features_vgg16(input_folder, output_folder, image_size=(224, 224)):
    """
    Extracts features from frames using VGG16.
    ...
    for split in ["train", "val"]:
        ...
        for category in categories:
            ...
            for frame_file in frames:
                ...
                print(f"Extracted VGG16 features for {frame_file} in {category}.")

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Extract VGG16 features from image frames")
    ...
    extract_features_vgg16(args.input_dir, args.output_dir)
